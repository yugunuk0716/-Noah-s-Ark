...
namespace FORGE3D
{
    ...
    public class TurretFXManager : MonoBehaviour
    {
        // Singleton instance
        private static TurretFXManager _instance;
        public static TurretFXManager instance { 
            get 
            { 
                return _instance; 
            } 
        ...
        public void SetTurretSocket(Transform[] trm) 
        {
            TurretSocket = trm;
        }
